...
Bear with me, this isn't a book about Python and this will be very brief, but it is important to understand how SALT interprets and collects, stores, and interprets information from your state files and commands. 
...
Python offers plain-word operators like `and`, `or`, and `not` for boolean operations. For example, suppose we have a box of mixed fruit containing 10 apples, 5 oranges, and 15 bananas. I ask you to tell me how many pieces of fruit in the box are apples and bananas. We have 30 pieces in total, but we only have 25 pieces that are apples and bananas.
